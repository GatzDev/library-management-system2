...
public class TransactionDaoImplTest {
    ...
    public void testAddTransaction() throws SQLException {
        ...
        // Arrange
        User user = new User(2, "Vergo Sabastian", "subi99@gmail.com");
        userDao.addUser(user);

        Book book = new Book(87, "Test Book", 2, 2020, "3456534545", 5);
        bookDao.addBook(book);

        LocalDate borrowingDate = LocalDate.now();
        LocalDate returnDate = borrowingDate.plusDays(14);
        ...
        try (PreparedStatement stmt = connection.prepareStatement("SELECT * FROM transactions WHERE id = ?")) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                Assertions.assertEquals(user.getId(), transaction.getUserId(), rs.getInt("user_id"));
                Assertions.assertEquals(book.getId(), transaction.getBookId(), rs.getInt("book_id"));
    ...
    public void testGetAllTransactions() throws SQLException {
        ...
        User user1 = new User(2, "Vergo Sabastian1", "subi992344@gmail.com");
        userDao.addUser(user1);

        User user2 = new User(3, "Vergo Sabastian2", "subi99@gmail.com");
        userDao.addUser(user2);

        Book book1 = new Book(87, "Test Book1", 5, 2001, "999999", 2);
        bookDao.addBook(book1);

        Book book2 = new Book(84, "Test Book2", 2, 2009, "6666666", 1);
        bookDao.addBook(book2);

        LocalDate borrowingDate1 = LocalDate.of(2023, 2, 13);
        LocalDate returnDate1 = LocalDate.of(2022, 6, 18);
        Transaction transaction1 = new Transaction(user1.getId(), book1.getId(), borrowingDate1, returnDate1);
