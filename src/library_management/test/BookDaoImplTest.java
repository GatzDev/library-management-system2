...
//        Book book = new Book( "title11", 1, 2013, "isbn43332", 1);
//        assertTrue(bookDao.addBook(book));
//    }
//
//    @Test
//    public void testUpdateBook() {
//        Book book = new Book( "title", 1, 2023, "isbn", 1);
...
//        // Arrange
//        Book book = new Book( "tdfdf", 2, 2001, "ISBN4565654", 1);
...
//        Book book1 = new Book( "bob401", 1, 2022, "ISBN123", 2);
//        Book book2 = new Book( "bob402", 2, 2021, "ISBN456", 1);
...
//        // Arrange
//        Book book1 = new Book( "Book to get 1", 1, 2022, "ISBN123", 1);
//        Book book2 = new Book( "Book to get 2", 2, 2021, "ISBN456", 2);
//        bookDao.addBook(book1);
//        bookDao.addBook(book2);
//
//        // Act
...
//        // Arrange
//        Book book = new Book( "Book by Id", 2, 2012, "ISBN1323223", 1);
...
//        // Arrange
//        Book book1 = new Book( "Book Get Available Book 1", 1, 2012, "ISBN123343", 1);
//        Book book2 = new Book( "Book Get Available Book 2", 2, 2013, "ISBN45634", 2);
//        Book book3 = new Book( "Book Get Available Book 3", 1, 2011, "ISBN7893454", 0);
//        bookDao.addBook(book1);
//        bookDao.addBook(book2);
...
//        // Arrange
//        int authorId = 6;
//        Book book1 = new Book( "Book By Author Id 1", authorId, 2012, "456546546", 1);
//        Book book2 = new Book( "Book By Author Id 2", authorId, 2013, "45645654456", 3);
//        Book book3 = new Book( "Book By Author Id 3", 2, 2011, "45645456450", 2);
//        bookDao.addBook(book1);
//        bookDao.addBook(book2);
//        bookDao.addBook(book3);
//
...
//        // Arrange
//        int limit = 1;
//        Book book1 = new Book( "Book Most Popular Books 1", 1, 2011, "1231232", 1);
//        Book book2 = new Book( "Book Most Popular Books 2", 2, 2011, "789789", 1);
//        Book book3 = new Book( "Book Most Popular Books 3", 5, 2011, "45460525", 1);
